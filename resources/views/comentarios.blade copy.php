  ...
  <section id="about" class="teams roomy-80" style="background-color:#f2f2ff;padding-bottom: 35px; padding-top: 35px; position:relative;top: -40px !important">
    ...
    <section  class="teams roomy-80" style="padding-top: 0px !important;">
        <div class="row">
            ...
            <div class="col-sm-8">
                <a onclick="goBack()"><button class="btn btn-primary" style="left: 30px; padding-top: 12px; padding-left: 15px;  padding-right: 15px;border-radius: 0.5rem; position:relative;"><h6 style="color:white;"><i class="nav-icon fa fa-arrow-left"></i> Voltar</h6></button></a>
                @if($dados['utilizador']->users_id == Auth::user()->id && $dados['pessoa_perdida']->estado == 1)
                    <a href="/desfecho/<?php echo $dados['pessoa_perdida']->idpessoa_perdida; ?>"><button class="btn btn-success" style="left: 40px;padding-top: 12px; padding-left: 15px;  padding-right: 15px;border-radius: 0.5rem; position:relative;"><h6 style="color:white;"><i class="nav-icon fa fa-eye-slash"></i> Desactivar</h6></button></a>
                @endif
                @if($dados['utilizador']->users_id == Auth::user()->id && $dados['pessoa_perdida']->estado == 0)
                    <a href="/activar/<?php echo $dados['pessoa_perdida']->idpessoa_perdida; ?>"><button class="btn btn-primary" style="left: 40px;padding-top: 12px; padding-left: 15px;  padding-right: 15px;border-radius: 0.5rem; position:relative;"><h6 style="color:white;"><i class="nav-icon fa fa-eye"></i> Activar</h6></button></a>
                @endif
            </div>
        </div>
        <div class="col-sm-2">
            ...
            <div class="col-sm-5">
                ...
                <!--<img src="/imagens/pessoas_perdidas/" alt="/imagens/pessoas_perdidas/default.png" width="100%" height="450px !important;">-->
                    ...
                    <li class="list-group-item rad ">
                        ...
                        <h6 class="text-muted" style="float:right !important"><?php $d=strtotime($dados['pessoa_perdida']->data_desaparecimento); echo date("d/m/Y", $d) ; ?></h6>
                    </li>
