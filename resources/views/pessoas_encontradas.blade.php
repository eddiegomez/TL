@extends('layouts.app')
  ...
  @section('content')
                        ...
                        <div class="page-top-info" style="height:50px">
                            <div class="container">
                                ...
                                <div class="site-pagination" style="display:inline">
                                    <a href="/">Home</a> /
                                    <a onclick="#">Pessoas encontradas</a> 
                                </div>
                            </div>
                        </div>
                    </div><!-- End off row -->
            ...
            <ul class="list-group" style="width:100%">
                ...
                <a href="#">
                <li href="eee" class="list-group-item rad active">
            ...
            @foreach ($pessoas_encontradas as $pessoa_encontrada)
                <div class="col-sm-3"style="">
                    ...
                    ></div>
                    <a target="_self" href="/detalhes/<?php echo $pessoa_encontrada->idpessoa_perdida; ?>">
                        <img src="/imagens/pessoas_perdidas/<?php echo $pessoa_encontrada->foto; ?>" alt="Fjords" width="300" style="height:300px">
                    </a>
                    <h3 style="text-align: center"><strong><?php echo $pessoa_encontrada->nome; ?> <?php echo $pessoa_encontrada->apelido; ?></strong></h3>
                    <div class="desc"><i class="nav-icon fa fa-calendar"></i>  <?php $d=strtotime($pessoa_encontrada->created_at); echo date("d/m/Y", $d) ; ?></div>
                    <center><a href="/detalhes/<?php echo $pessoa_encontrada->idpessoa_perdida; ?>"><button class="btn-primary" style="background-color: #008CBA; padding-top: 7px; padding-left: 15px;  padding-right: 15px;border-radius: 0.5rem; position:relative; bottom: 5px"><h6 style="color:white;"><i class="nav-icon fa fa-eye"></i></h6></button></a>
                    </center>
                    </div>
                </div>
            @endforeach
