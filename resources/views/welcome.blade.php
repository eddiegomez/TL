                                ...
                                <!--class="slid_shap bg-yellow" style="background-color:#1E90FF"-->
                                    ...
                                    <div id="card" class="service_slid_item text-center">
                                        ...
                                        <div class="service_slid_text"  style="height:305px;margin:0px;">
                                            <div class="com-md-12">
                                                <div class="col-md-6">
                                                    <img src="/imagens/pessoas_perdidas/{{$pessoa_perdida->foto}}" class="logo" alt=""  style="height:300px;">
                                                </div>
                                                <div class="col-md-6">
                                                <div class="row">
                                                ...
                                                <div class="row" style="top:-60px;position: relative">
                                                    ...
                                                    <div class="col-md-10" style="float-right">{{$pessoa_perdida->denominacao}}</div>
                                                </div>
                            ...
                            <div class="col-md-5 col-md-offset-1">
                                <div class="service_item sm-m-top-50">
                                    ...
                                    <div class="service_content">
                                        ...
                                        <div class="row">
                                        <a href="login">
                                            <button href="{{ route('login') }}" class="btn btn-default m-top-40" data-toggle="modal" data-target="#">Publicar</button>
                                        </a>
                                        <a href="{{ route('login') }}">
