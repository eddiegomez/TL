  ...
  @section('content')
            ...
            @foreach ($pessoas_perdidas as $pessoa_perdida)
                <div class="col-sm-3"style="">
                    ...
                    <h6 style="text-align: center"><i class="nav-icon fa fa-user"></i> <?php echo $pessoa_perdida->nome_user; ?> <?php echo $pessoa_perdida->apelido_user; ?></h6>
                    <div class="desc" style="position:relative;top: -12px"><i class="nav-icon fa fa-calendar"></i>  
                        <?php 
                            if(date("d", strtotime($pessoa_perdida->reg))==date("d")){
