<template>
  <div class="row">
    ...
    <div class="col-sm-5">
      <div class="card-tools" style="position: relative; top: 8px;right:0px"></div>
    </div>
            ...
            <div class="box box-primary">
              <div class="box-body box-profile">
                ...
                <ul class="list-group list-group-unbordered">
                  ...
                  <li class="list-group-item">
                    <b class="text-muted">
                      <i class="text-muted fas fa-user-circle"></i> Por
                    </b>
                    <a class="text-muted pull-right" style="float:right">{{pessoa_perdida.nom_user}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>
                    ...
                    <a
                      class="text-muted pull-right"
                      style="float:right"
                    >{{pessoa_perdida.provincia}} - {{pessoa_perdida.avenida}}, {{pessoa_perdida.bairro}},{{pessoa_perdida.numero}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>
                  ...
                  <li class="list-group-item">
                    ...
                    <a class="text-muted pull-right" style="float:right">{{pessoa_perdida.email}}</a>
                  </li>
                </ul>
  ...
  methods: {
    ...
    buscarCasos() {
      axios.get("api/pessoa_perdida").then(({ data }) => {
        this.pessoas_perdidas = data.por_familiares;
      });
    },
